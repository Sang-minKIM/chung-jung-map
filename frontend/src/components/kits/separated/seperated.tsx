 ...
 * MIT License
 *
 * Original code from: https://github.com/toss/react-simplikit
 ...
 * @param by - The component to insert between child elements.
 *
 * @returns A React component that separates children with a specified separator.
 *
 * @example
 * function App() {
 *   return (
